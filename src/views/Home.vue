<template>
	<div class="home grey lighten-5">
		...
		<v-card class=" grey lighten-5 maisEspaco" flat>
			...
			<v-card-title class="justify-center display-1 maisEspaco">Hi, I'm Marcio, web developer.</v-card-title>
			<v-card-text class="text-center">Java / Node / Angular / Vue / Wordpress </v-card-text>
